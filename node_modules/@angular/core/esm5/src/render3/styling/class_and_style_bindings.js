...
import {isProceduralRenderer, RendererStyleFlags3} from '../interfaces/renderer';
import {NO_CHANGE} from '../tokens';
import {getRootContext} from '../util/view_traversal_utils';
import {
  allowFlush as allowHostInstructionsQueueFlush,
  flushQueue as flushHostInstructionsQueue
} from './host_instructions_queue';
...
export function compareLogSummaries(a, b) {
  ...
  Object.keys(a.flags).forEach(function (name) {
