...
import {BINDING_INDEX, HEADER_OFFSET, RENDERER, T_HOST, TVIEW} from './interfaces/view';
...
export function ɵɵi18nPostprocess(message, replacements) {
  ...
  if (PP_MULTI_VALUE_PLACEHOLDERS_REGEXP.test(message)) {
    ...
    result = result.replace(PP_PLACEHOLDERS_REGEXP, function (m, phs, tmpl) {
      ...
      var _a = tslib_1.__read(placeholders[idx], 3), templateId = _a[0], isCloseTemplateTag = _a[1],
        placeholder = _a[2];
    ...
    var hasUnmatchedValues = Object.keys(matches_1).some(function (key) {
...
export function ɵɵi18nLocalize(input, placeholders) {
  ...
  return Object.keys(placeholders).length ?
    input.replace(LOCALIZE_PH_REGEXP, function (match, key) {
