...
import {__awaiter, __decorate, __extends, __generator, __read, __spread, __values} from 'tslib';
...
var R3TestBedCompiler = /** @class */ (function () {
  ...
  R3TestBedCompiler.prototype.applyProviderOverrides = function () {
    var _this = this;
    var maybeApplyOverrides = function (field) {
  ...
  R3TestBedCompiler.prototype.patchComponentsWithExistingStyles = function () {
    this.existingComponentStyles.forEach(function (styles, type) {
      return type[ɵNG_COMPONENT_DEF].styles = styles;
    });
  ...
  R3TestBedCompiler.prototype.clearComponentResolutionQueue = function () {
    ...
    clearResolutionOfComponentResourcesQueue().forEach(function (value, key) {
      return _this.originalComponentResolutionQueue.set(key, value);
    });
  };
  /*
  ...
  R3TestBedCompiler.prototype.compileTestModule = function () {
    ...
    var providers = __spread([
      ...
      {
        provide: Compiler, useFactory: function () {
          return new R3TestCompiler(_this);
        }
      }
  ...
  R3TestBedCompiler.prototype.getProviderOverrides = function (providers) {
    ...
    return flatten(flatten(providers, function (provider) {
      return _this.getSingleProviderOverrides(provider) || [];
    }));
  };
  ...
  R3TestBedCompiler.prototype.patchDefWithProviderOverrides = function (declaration, field) {
    ...
    if (def && def.providersResolver) {
      ...
      var processProvidersFn_1 = function (providers) {
        return _this.getOverriddenProviders(providers);
      };
      this.storeFieldOfDefOnType(declaration, field, 'providersResolver');
      def.providersResolver = function (ngDef) {
        return resolver_1(ngDef, processProvidersFn_1);
      };
    }
  };
  ...
  R3TestCompiler.prototype.compileModuleAsync = function (moduleType) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.testBed._compileNgModuleAsync(moduleType)];
          case 1:
            _a.sent();
  ...
  R3TestCompiler.prototype.compileModuleAndAllComponentsAsync = function (moduleType) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.compileModuleAsync(moduleType)];
          case 1:
...
var TestBedViewEngine = /** @class */ (function () {
  ...
  TestBedViewEngine.prototype._createCompilerAndModule = function () {
    ...
    var declarations = __spread(this._declarations, this._templateOverrides.map(function (entry) {
...
export {
  TestBedRender3 as ɵangular_packages_core_testing_testing_b,
  _getTestBedRender3 as ɵangular_packages_core_testing_testing_c,
  TestBedViewEngine as ɵangular_packages_core_testing_testing_a,
  TestBed,
  getTestBed,
  inject,
  InjectSetupWrapper,
  withModule,
  MetadataOverrider as ɵMetadataOverrider,
  async,
  ComponentFixture,
  resetFakeAsyncZone,
  fakeAsync,
