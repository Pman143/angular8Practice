      ...
      return {
        ...
        buildParams: function () {
          ...
          var attrArray = !attrs.some(function (attr) {
            return attr instanceof o.WrappedNodeExpr;
          }) ?
    ...
    if (this.hasBindings) {
      return {
        ...
        buildParams: function () {
          ...
          var styleBindingProps = _this._singleStyleInputs ? _this._singleStyleInputs.map(function (i) {
            return o.literal(i.name);
          }) : [];
          // a string array of every class-based binding
          var classBindingNames = _this._singleClassInputs ? _this._singleClassInputs.map(function (i) {
            return o.literal(i.name);
          }) : [];
