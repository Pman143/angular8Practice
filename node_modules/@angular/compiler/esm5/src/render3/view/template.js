...
export function prepareEventListenerParameters(eventAst, handlerName, scope) {
  ...
  var type = eventAst.type, name = eventAst.name, target = eventAst.target, phase = eventAst.phase,
...
var TemplateDefinitionBuilder = /** @class */ (function () {
  ...
  TemplateDefinitionBuilder.prototype.i18nTranslate = function (message, params, ref, transformFn) {
    ...
    if (params && Object.keys(params).length) {
      Object.keys(params).forEach(function (key) {
        return _params[formatI18nPlaceholderName(key)] = params[key];
      });
    }
  ...
  TemplateDefinitionBuilder.prototype.i18nEnd = function (span, selfClosing) {
    ...
    if (bindings.size) {
      bindings.forEach(function (binding) {
        _this.updateInstruction(index, span, R3.i18nExp, function () {
  ...
  TemplateDefinitionBuilder.prototype.visitBoundText = function (text) {
    ...
    this.updateInstruction(nodeIndex, text.sourceSpan, R3.textBinding, function () {
      return [o.literal(nodeIndex), _this.convertPropertyBinding(value)];
    });
  };
    ...
    attrs.forEach(function (input) {
      if (input instanceof t.BoundAttribute) {
        ...
        _this.updateInstruction(templateIndex, template.sourceSpan, R3.property, function () {
          return [o.literal(input.name), _this.convertPropertyBinding(value_4, true)];
        });
      }
    });
  };
  ...
  TemplateDefinitionBuilder.prototype.processStylingInstruction = function (instruction, createMode) {
    ...
    if (instruction) {
      var paramsFn = function () {
        return instruction.buildParams(function (value) {
          return _this.convertPropertyBinding(value, true);
        });
      };
      if (createMode) {
  ...
  TemplateDefinitionBuilder.prototype.convertPropertyBinding = function (value, skipBindFn) {
    var _a;
    var interpolationFn = value instanceof Interpolation ? interpolate : function () {
      return error('Unexpected interpolation');
    };
  ...
  TemplateDefinitionBuilder.prototype.getUpdateInstructionArguments = function (value) {
    var _a;
    var _b = convertUpdateArguments(this, this.getImplicitReceiverExpr(), value, this.bindingContext()), args = _b.args,
      stmts = _b.stmts;
...
function getLiteralFactory(constantPool, literal, allocateSlots) {
  var _a = constantPool.getLiteralFactory(literal), literalFactory = _a.literalFactory,
...
export function parseTemplate(template, templateUrl, options) {
  ...
  var parseResult = htmlParser.parse(template, templateUrl, tslib_1.__assign({}, options, {
  ...
  var _a = htmlAstToRender3Ast(rootNodes, bindingParser), nodes = _a.nodes, errors = _a.errors,
    styleUrls = _a.styleUrls, styles = _a.styles;
