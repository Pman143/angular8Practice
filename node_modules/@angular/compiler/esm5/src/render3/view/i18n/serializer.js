...
var SerializerVisitor = /** @class */ (function () {
  ...
  SerializerVisitor.prototype.visitText = function (text, context) {
    return text.value;
  };
  ...
  SerializerVisitor.prototype.visitTagPlaceholder = function (ph, context) {
    ...
    return ph.isVoid ?
      ...
      "" + formatPh(ph.startName) + ph.children.map(function (child) {
        return child.visit(_this);
      }).join('') + formatPh(ph.closeName);
  };
  SerializerVisitor.prototype.visitPlaceholder = function (ph, context) {
    return formatPh(ph.name);
  };
