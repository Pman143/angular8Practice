...
var CompilerFacadeImpl = /** @class */ (function () {
  ...
  CompilerFacadeImpl.prototype.compileComponent = function (angularCoreEnv, sourceMapUrl, facade) {
    ...
    var res = compileComponentFromMetadata(tslib_1.__assign({}, facade, convertDirectiveFacadeToMetadata(facade), {
  ...
  CompilerFacadeImpl.prototype.compileBase = function (angularCoreEnv, sourceMapUrl, facade) {
    var constantPool = new ConstantPool();
    var meta = tslib_1.__assign({}, facade, {
...
function convertToR3QueryMetadata(facade) {
  return tslib_1.__assign({}, facade, {
