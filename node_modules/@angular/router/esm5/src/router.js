...
var Router = /** @class */ (function () {
  ...
  Router.prototype.setupNavigations = function (transitions) {
    ...
    return transitions.pipe(filter(function (t) {
      ...
      // Extract URL
      map(function (t) {
        return (tslib_1.__assign({}, t, {extractedUrl: _this.urlHandlingStrategy.extract(t.rawUrl)}));
      }),
      ...
      switchMap(function (t) {
        ...
        return of(t).pipe(
          ...
          tap(function (t) {
            ...
            if (processCurrentUrl) {
              return of(t).pipe(
                ...
                // Recognize
                recognize(_this.rootComponentType, _this.config, function (url) {
              ...
              if (processPreviousUrl) {
                ...
                return of(tslib_1.__assign({}, t, {
                  targetSnapshot: targetSnapshot,
                  urlAfterRedirects: extractedUrl,
                  extras: tslib_1.__assign({}, extras, {skipLocationChange: false, replaceUrl: false})
                }));
              } else {
          ...
          tap(function (t) {
            ...
            return (tslib_1.__assign({}, t, {guards: getAllRouteGuards(t.targetSnapshot, t.currentSnapshot, _this.rootContexts)}));
