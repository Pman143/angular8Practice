...
import {BehaviorSubject, combineLatest, defer, EMPTY, EmptyError, from, Observable, of, Subject} from 'rxjs';
import {
  catchError,
  concatAll,
  concatMap,
...
var ActivatedRoute = /** @class */ (function () {
  ...
  Object.defineProperty(ActivatedRoute.prototype, "queryParamMap", {
    get: function () {
      if (!this._queryParamMap) {
        this._queryParamMap =
          this.queryParams.pipe(map(function (p) {
            return convertToParamMap(p);
          }));
      }
      return this._queryParamMap;
...
var ApplyRedirects = /** @class */ (function () {
  ...
  ApplyRedirects.prototype.matchSegmentAgainstRoute = function (ngModule, rawSegmentGroup, route, segments) {
    ...
    return childConfig$.pipe(mergeMap(function (routerConfig) {
      ...
      var _a = split(rawSegmentGroup, consumedSegments, rawSlicedSegments, childConfig), segmentGroup = _a.segmentGroup,
...
function runCanLoadGuard(moduleInjector, route, segments) {
  ...
  return obs.pipe(concatAll(), every(function (result) {
    return result === true;
  }));
}
...
function applyRedirects$1(moduleInjector, configLoader, urlSerializer, config) {
  return function (source) {
    return source.pipe(switchMap(function (t) {
      return applyRedirects(moduleInjector, configLoader, urlSerializer, t.extractedUrl, config)
        .pipe(map(function (urlAfterRedirects) {
          return (__assign({}, t, {urlAfterRedirects: urlAfterRedirects}));
        }));
    }));
  };
}
...
function prioritizedGuardValue() {
  return switchMap(function (obs) {
    return combineLatest.apply(void 0, __spread(obs.map(function (o) {
...
function checkGuards(moduleInjector, forwardEvent) {
  return function (source) {
    return source.pipe(mergeMap(function (t) {
      var targetSnapshot = t.targetSnapshot, currentSnapshot = t.currentSnapshot, _a = t.guards,
        canActivateChecks = _a.canActivateChecks, canDeactivateChecks = _a.canDeactivateChecks;
      ...
      return runCanDeactivateChecks(canDeactivateChecks, targetSnapshot, currentSnapshot, moduleInjector)
        .pipe(mergeMap(function (canDeactivate) {
          ...
          return (__assign({}, t, {guardsResult: guardsResult}));
        }));
    }));
  };
}
...
function recognize$1(rootComponentType, config, serializer, paramsInheritanceStrategy, relativeLinkResolution) {
  return function (source) {
    return source.pipe(mergeMap(function (t) {
      return recognize(rootComponentType, config, t.urlAfterRedirects, serializer(t.urlAfterRedirects), paramsInheritanceStrategy, relativeLinkResolution)
        .pipe(map(function (targetSnapshot) {
          return (__assign({}, t, {targetSnapshot: targetSnapshot}));
        }));
    }));
  };
}
...
function resolveNode(resolve, futureARS, futureRSS, moduleInjector) {
  ...
  return runningResolvers$.pipe(last$1(), map(function () {
    return data;
  }));
}
...
var Router = /** @class */ (function () {
  ...
  Router.prototype.setupNavigations = function (transitions) {
    ...
    return transitions.pipe(filter(function (t) {
      ...
      // Extract URL
      map(function (t) {
        return (__assign({}, t, {extractedUrl: _this.urlHandlingStrategy.extract(t.rawUrl)}));
      }),
      ...
      switchMap(function (t) {
        ...
        return of(t).pipe(
          ...
          tap(function (t) {
            ...
            if (processCurrentUrl) {
              return of(t).pipe(
                ...
                }, _this.paramsInheritanceStrategy, _this.relativeLinkResolution),
              ...
              if (processPreviousUrl) {
                var id = t.id, extractedUrl = t.extractedUrl, source = t.source, restoredState = t.restoredState,
                  extras = t.extras;
                ...
                return of(__assign({}, t, {
                  ...
                  extras: __assign({}, extras, {skipLocationChange: false, replaceUrl: false})
                }));
              } else {
          ...
          switchTap(function (t) {
            var targetSnapshot = t.targetSnapshot, navigationId = t.id, appliedUrlTree = t.extractedUrl,
              rawUrlTree = t.rawUrl, _a = t.extras, skipLocationChange = _a.skipLocationChange,
          ...
          tap(function (t) {
            ...
            return (__assign({}, t, {guards: getAllRouteGuards(t.targetSnapshot, t.currentSnapshot, _this.rootContexts)}));
  ...
  Router.prototype.createUrlTree = function (commands, navigationExtras) {
    ...
    var relativeTo = navigationExtras.relativeTo, queryParams = navigationExtras.queryParams,
      fragment = navigationExtras.fragment, preserveQueryParams = navigationExtras.preserveQueryParams,
      queryParamsHandling = navigationExtras.queryParamsHandling, preserveFragment = navigationExtras.preserveFragment;
